...
import { createCrmCliente } from "../../../crm-actions";
...
export default function NovoCliente() {
  return (
    <div className="max-w-xl">
      ...
      <form action={createCrmCliente} className="flex flex-col gap-5">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/admin/crm/clientes" className="text-sm text-gelo-dim hover:text-gelo">
            Cancelar
          </Link>
        </div>
      </form>
